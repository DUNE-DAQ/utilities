 ...
 */
#ifndef TOOLBOX_INCLUDE_TOOLBOX_FILESOURCEBUFFER_HPP_
#define TOOLBOX_INCLUDE_TOOLBOX_FILESOURCEBUFFER_HPP_
  ...
  void read(const std::string& sourcefile)
  {
    ...
    try {
      ...
      if (m_chunk_size > 0) {
        ...
        TLOG_DEBUG(15) << "Available elements: " << std::to_string(m_element_count);
      }
...
#endif // TOOLBOX_INCLUDE_TOOLBOX_FILESOURCEBUFFER_HPP_
